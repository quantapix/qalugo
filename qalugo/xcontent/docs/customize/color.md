...
<div class="row font-monospace">
  ...
  {{- range $color := $.Site.Data.colors }}
    ...
    <div class="col-md-4 mb-3">
      ...
      <div class="p-3 qal-{{ $color.name }}-{{ . }}">${{ $color.name }}-{{ . }}</div>
      {{ end }}
    </div>
    {{ end -}}
  {{ end -}}
  ...
  {{- range $.Site.Data.grays }}
    <div class="p-3 qal-gray-{{ .name }}">$gray-{{ .name }}</div>
  {{ end -}}
  </div>
  {{< /theme-colors.inline >}}

  <div class="col-md-4 mb-3">
    <div class="p-3 mb-2 qal-black text-white">
      <strong class="d-block">$black</strong>
      #000
    </div>
    <div class="p-3 mb-2 qal-white border">

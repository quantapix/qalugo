...
{{< example class="qal-app-row qal-app-row-flex-cols" >}}
<div class="container">
...
In addition to column clearing at responsive breakpoints, you may need to reset offsets. See this in action in [the grid example]({{< appsref "/grid" >}}).
